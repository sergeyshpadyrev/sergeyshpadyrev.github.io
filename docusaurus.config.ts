...
const config: Config = {
  ...
  organizationName: "sergeyshpadyrev",
  projectName: "sergeyshpadyrev.github.io",
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        { to: "/docs/publications", label: "Эссе", position: "left" },
        { to: "/docs/category/посты", label: "Посты", position: "left" },
