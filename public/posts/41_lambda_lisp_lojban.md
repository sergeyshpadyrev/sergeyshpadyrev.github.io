...
В библейском тексте сокрыто огромное количество различных смыслов и символов. В первой главе книги "Бытие", первой книги еврейской Торы и христианского Ветхого Завета, говорится следующее: "В начале сотворил Бог небо и землю". Здесь имеются в виду не буквальные земля и небо, а что-то совершенно иное. Слово "небо" на иврите пишется как "שמים" (шамаим) и является мужским множественным числом от слова "שׁם" (шем), означающего "имя". То есть "небеса" на иврите буквально означают "имена". Хотя само слово "имена" в современном иврите использует женское множественное число - "שמות" (шемот).
...
Основной синтаксической единицей Ложбана служит предикат selbri, в чём-то подобный глаголам русского языка, но не совсем эквивалентный им. Каждый предикат selbri - это как функция в LISP с определённым количеством определённых аргументов.
