...
- Метаутопия программистов: как построить государство на базе TypeScript и Git (
  [Хабр](https://habr.com/ru/articles/989562/)
  / [Пикабу](https://pikabu.ru/story/metautopiya_programmistov_kak_postroit_gosudarstvo_na_baze_typescript_i_git_13651242)
  / [Дзен](https://dzen.ru/a/aX8US8tu-kAyqLX1)
  / [Копия](./essays/54_state_as_code.md) )
- Цивилизация на основе контейнеров: как выйти в следующий техноуклад с помощью морских контейнеров и Майнкрафта (
  [Хабр](https://habr.com/ru/articles/991536/)
  / [Пикабу](https://pikabu.ru/story/tsivilizatsiya_na_osnove_konteynerov_kak_vyiyti_v_sleduyushchiy_tekhnouklad_s_pomoshchyu_morskikh_konteynerov_i_maynkrafta_13659077)
  / [Дзен](https://dzen.ru/a/aYIoERD91X8JjflW)
  / [Копия](./essays/55_containers.md) )
- Символы, симулякры и системы: как язык определяет мышление (
  [Хабр](https://habr.com/ru/articles/992098/)
  / [Пикабу](https://pikabu.ru/story/simvolyi_simulyakryi_i_sistemyi_chast_1_13695691)
  / [Дзен](https://dzen.ru/a/aZF1fxr1Mns3dj8M)
  / [Копия](./essays/56_symbols.md) )
- Величайший системный кризис человечества: в шаге от катастрофы XXI века (
  [Хабр](https://habr.com/ru/articles/1000966/)
  / [Пикабу](https://pikabu.ru/story/velichayshiy_sistemnyiy_krizis_chelovechestva_v_shage_ot_katastrofyi_xxi_veka_chast_1_13727682)
  / [Дзен](https://dzen.ru/a/aZ6yAvYyvGl820kX)
  / [Копия](./essays/57_crisis.md) )
